...
import com.example.microdysis.emolancehr.HardwareConnectorFragment;
...
public abstract class CapabilityFragment extends HardwareConnectorFragment {
    ...
    protected String getCallbackSummary() {
        ...
        for (Map.Entry<String, String> entry : mCallbackResults.entrySet()) {
            sb.append(entry.getKey()).append(": ").append(entry.getValue()).append("\n");
        }
        return sb.toString().trim();
    }

    protected Capability getCapability(Capability.CapabilityType capabilityType) {
    ...
    public static CapabilityFragment create(Capability.CapabilityType capabilityType, ConnectionParams params) {
    ...
    protected static Button createSimpleButton(Context context, String text, View.OnClickListener ocl) {
    ...
    protected static String summarizeGetters(Class<?> clazz, Object object) {
        ...
        if (object != null) {
            ...
            if (object instanceof Capability.Data) {
                Capability.Data data = (Capability.Data) object;
